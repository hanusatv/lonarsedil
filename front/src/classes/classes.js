...
export class Fyritoka {
    ...
    static async heintaOll() {
        try {
            const response = await fetch(`${baseUrl}/fyritoka`);
            return await response.json();
        } catch (error) {
            console.log(error);
        }
    ...
    static async heintaEina(id) {
        try {
            const response = await fetch(`${baseUrl}/fyritoka/${id}`);
            //Pass the response to the LontakariData class, which will create a new object with the data from the response
            return new FyritokaData(await response.json());
        } catch (error) {
            console.log(error);
        }
    }
