...
<div class="lontakari-tabel">
	<div class="employees-single-employment-tab">
        <div class="ant-card-body">
            <div class="ant-row">
                <!-- Header -->
                <h1 class="h1">Løntakari: {lonarfolk.Navn}</h1>
                <!-- Body1 -->
                <div class="body1">
                    <div class="lontakari-info">Starvsheiti:<br>
                        <strong>{lonarfolk.Starvsheiti}</strong>
                    </div>
                    <div class="lontakari-info">Bústaður:<br>
                        <strong>{lonarfolk.Bustadur}</strong>
                    </div>
                    <div class="lontakari-info">Býur:<br>
                        <strong>{lonarfolk.Bydur}</strong>
                    </div>
                    <div class="lontakari-info">Mail:<br>
                        <strong>{lonarfolk.Mail}</strong>
                    </div>
                    <div class="lontakari-info">Telefon:<br>
                        <strong>{lonarfolk.Telefon}</strong>
                    </div>
                    <div class="lontakari-info">Føðingardagur:<br>
                        <strong>{lonarfolk.Fødingardagur}</strong>
                    </div>
                </div>
                <!-- Body 2 -->
                <div class="body2">
                    <div class="lontakari-info">P-Tal:<br>
                        <strong>{lonarfolk.Ptal}</strong>
                    </div> 
                    <div class="lontakari-info">Starvsetanardagur:<br>
                        <strong>{lonarfolk.Starvsetanardagur}</strong>
                    </div> 
                    <div class="lontakari-info">Slag av inntøku:<br>
                        <strong>{lonarfolk.Slagavinntøku}</strong>
                    </div>
                    <div class="lontakari-info">Løn brutto:<br>
                        <strong>{lonarfolk.Løn}</strong>
                    </div>
                    <div class="lontakari-info">Rest feria:<br>
                        <strong>{lonarfolk.Restferia} dagar</strong>
                    </div>
                    <label class="lontakari-info" for="lonar-tittleiki-dropdown">Lønar títtleiki:</label>
...
.lonar-tittleiki-dropdown select:active, .lonar-tittleiki-dropdown select:focus {
  outline: none;
  box-shadow: none;
  background-color: #2b3044;
}
